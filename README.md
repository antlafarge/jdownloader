...
**`<JAVA_OPTIONS>`** | [Env](https://docs.docker.com/engine/reference/run/#env-environment-variables) | Optional Java options to use.<br>*Use `-Xms128m -Xmx1g` to change initial and max memory.* | Optional (no options)
